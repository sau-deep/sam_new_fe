...
const STATIC_RESOURCES = [
  {
    ...
    preview: null,
    downloadUrl: `${process.env.PUBLIC_URL}/Mobile_SoP_Routine_Monitoring.pptx`,
    fileName: "Mobile_SoP_Routine_Monitoring.pptx",
    available: true,
  },
  {
    id: 2,
    title: "CMAM Concurrent Assessment Questionnaire",
    description: "CMAM concurrent assessment questionnaire in PDF format",
    tags: ["Questionnaire", "Assessment", "CMAM"],
    category: "Protocols",
    fileType: "PDF",
    icon: <FilePdfOutlined style={{ color: "#E2231A", fontSize: 24 }} />,
    preview: null,
    downloadUrl: `${process.env.PUBLIC_URL}/CMAM_Concurrent_Assessment_Questionnaire.pdf`,
    fileName: "CMAM_Concurrent_Assessment_Questionnaire.pdf",
    available: true,
  },
];
