...
const BELSurvey2024 = () => {
  ...
  const convertToReadableFormat = (formData) => {
    ...
    const questionMappings = {
      ...
      'q10_vision': { question: 'Rate senior leadership - Vision & strategy communication', options: { 'a_plus': 'A+', 'a': 'A', 'b': 'B', 'c': 'C', 'd': 'D' } },
      'q10_transparency': { question: 'Rate senior leadership - Transparency in decision-making', options: { 'a_plus': 'A+', 'a': 'A', 'b': 'B', 'c': 'C', 'd': 'D' } },
      'q10_feedback': { question: 'Rate senior leadership - Acting on employee feedback', options: { 'a_plus': 'A+', 'a': 'A', 'b': 'B', 'c': 'C', 'd': 'D' } },
      'q10_change': { question: 'Rate senior leadership - Leading through change', options: { 'a_plus': 'A+', 'a': 'A', 'b': 'B', 'c': 'C', 'd': 'D' } },
